...
exports.opcoes = function (req, res) { 
    ...
    res.render('simposio/2022/pt-BR/certificados/esquenta-1/opcoes', 
        {
...
exports.obter = async function (req, res) {
    try{
        console.log('Certificado Esquenta 2022.1')
        ...
        if (encontrado) {
            res.render('simposio/2022/pt-BR/certificados/esquenta-1/obter-lista',
                {
                    layout: 'simposio/2022/pt-BR/layout', 
                    certificado: true,
                    titulo: 'Certificado', 
...
exports.obterArquivo = async function (req, res) {
    try{
        ...
        const sheets = new GoogleSpreadsheet('1PVmQ0SWG635jevdIQPh8ToUNdzCmwPK6k9MYP_KhxaQ')
        ...
        if ( posicao !== -1 ) {
            ...
            doc.image('resources/simposio/2022/pt-BR/modelos/esquenta-1.png', 0, 0,{
                fit: [841.92, 594.96],
            })
            doc.fontSize(18)
            ...
            if(novoTextoBase.length > 400)
                doc.fontSize(16)
            doc.text(novoTextoBase, 125, 255, {width: 600, align: 'justify'})
            doc.fontSize(9.5)
            doc.text(`Use o código ${codigo} para validar o certificado em: \nhttps://www.educompbrasil.org/simposio/2022/certificados/esquenta/1/validar`, 120, 500, {width:600, align: 'left'})
            doc.end()
