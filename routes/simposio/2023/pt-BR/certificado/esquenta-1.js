...
const nome_evento = "Esquenta I - EduComp 2023"
const data_evento = "27/02/2023"
const base_name = "esquenta-1"
const layout = 'simposio/2023/pt-BR/layout'
const base_view = "simposio/2023/pt-BR/certificados/" + base_name + "/"
const template_url = "resources/simposio/2023/pt-BR/modelos/" + base_name + ".png"
const font_url = 'resources/simposio/2023/pt-BR/fonts/trebuc.ttf'
const codigo_planilha = '1CIU_20WZ8J1FpyGHpNlis9NNo7NreBo8F_NZSZOMWco'
...
exports.obterArquivo = async function (req, res) {
    try{
      ...
      doc.fontSize(9.5)
      doc.text(`Use o código ${codigo} para validar o certificado em: \nwww.educompbrasil.org/simposio/2023/certificados/esquenta/1/validar`, 200, 560, {width:600, align: 'left'})
      doc.end()
