...
const nome_evento = "EduComp 2023"
const data_evento = "24 a 29/04/2023"
...
const codigo_planilha = '1Arss5wqltY3bSm0rRKADh56CHyXVQEnha1cUz-2b5N0'
...
exports.obterArquivo = async function (req, res) {
    try{
      ...
      doc.fontSize(9.5)
      doc.text(`Use o código ${codigo} para validar o certificado em: \nwww.educompbrasil.org/`+ base_view + `validar`, 200, 560, {width:600, align: 'left'})
      doc.end()
