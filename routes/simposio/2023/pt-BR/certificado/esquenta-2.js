...
const codigo_planilha = '1LFtMpLBEbY017k1nSwFVarpLzjc4Y1W5JdhFZSnWet0'
...
exports.obterArquivo = async function (req, res) {
    try{
      ...
      doc.fontSize(9.5)
      doc.text(`Use o código ${codigo} para validar o certificado em: \nwww.educompbrasil.org/simposio/2023/certificados/esquenta/2/validar`, 200, 560, {width:600, align: 'left'})
      doc.end()
