exports.trabalhos = function (req, res) {
  res.render('simposio/2026/sbc-eb/pt-BR/chamadas/trabalhos', {
...
exports.aceitos = function (req, res) {
  res.render('simposio/2026/sbc-eb/pt-BR/chamadas/trabalhos-aceitos', {
    layout: 'simposio/2026/pt-BR/layout',
    chamadas: true,
    isSbceb: true,
...
exports.orientacoes_apresentacao = function (req, res) {
  res.render('simposio/2026/sbc-eb/pt-BR/chamadas/orientacoes-apresentacao', {
    layout: 'simposio/2026/pt-BR/layout',
    chamadas: true,
    isSbceb: true,
