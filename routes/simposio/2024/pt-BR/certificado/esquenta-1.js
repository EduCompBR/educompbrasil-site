...
const nome_evento = "Esquenta I - EduComp 2024"
const data_evento = "22/03/2024"
...
const codigo_planilha = '1W3Q4HfdO_u2iKqrWvhVQWmBkIlzXlvSVhl8pno3TTN8'
...
exports.obterArquivo = async function (req, res) {
    try{
      ...
      if(novoTextoBase.length > 400)
          doc.fontSize(16)
      doc.text(novoTextoBase, 150, 280, {width: 550, align: 'justify'})
      doc.fontSize(9.5)

      //Rotacionar para colocar o código
      doc.rotate(270, { origin: [10,520] })
      doc.text(`Use o código ${codigo} para validar o certificado em: \nwww.educompbrasil.org/simposio/2024/certificados/esquenta/1/validar`, 10, 520, {width:600, align: 'left'})
      doc.rotate(-270, { origin: [10,520] })
